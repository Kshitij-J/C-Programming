// In Fantasyland, everyone who earns strictly more than Y rupees per year, has to pay a tax to Seema.
//Seema has allowed a special scheme where you can invest any amount of money and claim exemption for it.
...
int main()
{
    ...
    if (0 <= X && X > Y && 0 <= Y)
    {
        cout << "Investment to be made: " << (X - Y);
    }
    else
    {
